    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <div class="hero-actions slide-up-delay-2">
          <NuxtLink to="/add-problem" class="btn btn-primary btn-lg shine-effect">Create a Problem</NuxtLink>
          <NuxtLink to="/questions" class="btn btn-glass btn-lg">Browse Bank</NuxtLink>
        </div>
      </div>
    </section>
    ...
    <section class="content-section">
      ...
      <div class="feature-grid">
        <NuxtLink to="/questions" class="feature-card card-glass" style="--i:0">
          ...
          <p>Search and filter your question bank. Preview LaTeX formulae inline effortlessly.</p>
          <span class="btn-text" style="margin-top:auto">Explore →</span>
        </NuxtLink>

        <NuxtLink to="/papers" class="feature-card card-glass" style="--i:1">
          <div class="feature-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" class="feature-icon-svg">
          ...
          <p>Pick questions from the bank and arrange them into a complete beautifully formatted test paper.</p>
          <span class="btn-text" style="margin-top:auto">Start Building →</span>
        </NuxtLink>

        <NuxtLink to="/add-problem" class="feature-card card-glass" style="--i:2">
          <div class="feature-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" class="feature-icon-svg">
        ...
        <NuxtLink to="/latex" class="feature-card card-glass" style="--i:3">
          <div class="feature-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" class="feature-icon-svg">
              <path d="M9 4h8"></path>
...
.feature-card h2 { font-size: 1.15rem; font-weight: 700; transition: color 0.3s ease; }
.feature-card:hover h2 { color: var(--color-primary); }
.feature-card p  { font-size: .95rem; color: var(--color-muted); flex: 1; line-height: 1.5; }
...
.btn-text.highlight { color: var(--color-primary); }
...
.slide-up-delay-2 {
  animation: slideUp 2.0s cubic-bezier(0.16, 1, 0.3, 1) backwards;
...
@media (prefers-reduced-motion: reduce) {
  .feature-card, .slide-up, .bounce-in, .slide-up-delay, .slide-up-delay-2, .shine-effect::after {
    animation: none;
    transition: none;
  }
}
